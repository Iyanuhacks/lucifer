...
def usage():
    ...
    print()
    print("Usage: lucifer.py -t target_host -p port")
    print(
    ...
    print()
    print("Examples: ")
    print("lucifer.py -t 192.168.0.1 -p 5555 -l -c")
    print("lucifer.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print("lucifer.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEFGHI' | ./lucifer.py -t 192.168.11.12 -p 135")
    print("script by iyanuhacks")
